...
data class FileNodeContext(
    val changeFile: com.gitlab.idea.model.GitLabMergeRequestChangeFile,
...
fun fileStatusForChangeType(changeType: com.gitlab.idea.model.GitLabMergeRequestChangeType): FileStatus {
    return when (changeType) {
        com.gitlab.idea.model.GitLabMergeRequestChangeType.ADDED -> FileStatus.ADDED
        com.gitlab.idea.model.GitLabMergeRequestChangeType.MODIFIED -> FileStatus.MODIFIED
        com.gitlab.idea.model.GitLabMergeRequestChangeType.DELETED -> FileStatus.DELETED
        com.gitlab.idea.model.GitLabMergeRequestChangeType.RENAMED -> FileStatus.MODIFIED
    }
}
