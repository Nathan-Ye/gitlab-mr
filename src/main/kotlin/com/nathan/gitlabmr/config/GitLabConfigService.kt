package com.nathan.gitlabmr.config

import com.nathan.gitlabmr.model.GitLabServer
import com.nathan.gitlabmr.model.GitLabServerList
...
@State(
    ...
    storages = [Storage("GitLabMRConfig.xml")]
)
