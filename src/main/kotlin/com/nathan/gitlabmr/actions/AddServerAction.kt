package com.nathan.gitlabmr.actions

import com.nathan.gitlabmr.config.GitLabConfigService
import com.nathan.gitlabmr.toolwindow.GitLabServerDialog
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        if (dialog.showAndGet()) {
            ...
            if (server != null) {
                ...
                // 显示成功消息并刷新工具窗口
                com.nathan.gitlabmr.util.GitLabNotifications.showSuccess(
                    project,
                    "添加成功",
                ...
                toolWindow?.contentManager?.let { contentManager ->
                    ...
                    val toolWindowContent = component?.getClientProperty("gitlab.toolwindow.content") as? com.nathan.gitlabmr.toolwindow.GitLabToolWindowContent
